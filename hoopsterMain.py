...
#label = customtkinter.CTkLabel(master=frame, text="HOOPSTER", font=('Courier New', 50))
hoopsterLogo = customtkinter.CTkImage(dark_image=Image.open("images/HoopsterLogo.png"), size=(197,165.5))
label = customtkinter.CTkLabel(master=frame, image=hoopsterLogo, text="")
